...
@section('title', 'Actualzar Perfil')
@section('content')
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Actualizar dados') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('setting.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="old_password" autocomplete="new-password">
                            </div>
                        </div>
